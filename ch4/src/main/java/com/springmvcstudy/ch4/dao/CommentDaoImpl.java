package com.springmvcstudy.ch4.dao;

import com.springmvcstudy.ch4.domain.CommentDto;
...
public class CommentDaoImpl implements CommentDao {
    ...
    private static String namespace = "com.springmvcstudy.ch4.dao.CommentMapper.";
