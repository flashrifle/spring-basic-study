...
public class UserDaoImplTest {
    ...
    public void deleteUser() {
        ...
        System.out.println("userDao.selectUser(String.valueOf(user)) = " + userDao.selectUser(user.getId()));
    }

    @Test
    public void selectUser() {
        User user = new User("asdf2", "1234", "abc", "aaa@aaa.com", new Date(), "fb", new Date());
        System.out.println("userDao.selectUser(user.getId()) = " + userDao.selectUser(user.getId()));
    }
    @Test
