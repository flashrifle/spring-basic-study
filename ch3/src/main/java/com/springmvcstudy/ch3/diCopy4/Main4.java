package com.springmvcstudy.ch3.diCopy4;
...
class AppContext {
    ...
    private void doComponentScan() {
        try {
            ...
            Set<ClassPath.ClassInfo> set = classPath.getTopLevelClasses("com.springmvcstudy.ch3.diCopy4");
...
public class Main4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Car car = (Car)ac.getBean("car");   // byName 객체검색
        Car car2 = (Car)ac.getBean(Car.class);  // byType 객체검색
